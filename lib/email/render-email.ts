...
// paragraphs, a single line break within a block becomes <br>, and every
// character is HTML-escaped first so nothing in the source text — sender-
// typed or substituted from lead data — can be interpreted as markup.
